...
\begin{frame}
	...
	\begin{description}
		...
		\item[Probabilistic] Chi-square\citep{Swan:1999:EST:319950.319956}, Naive Bayes
		\item[Graph-based] Draw edges in a graph for cooccurrences of a word. \citep{saha2012learning}
                \item[Language Models] Provide the probability of a story given a topic. \citep{allan2000detections}
	\end{description}
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{images/keygraph}
\caption{source: \url{http://www.cs.umd.edu/~sayyadi/keygraph.html}}
\end{figure}
\end{frame}
